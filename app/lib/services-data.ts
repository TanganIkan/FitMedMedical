...
export const servicesData = [
  {
    id: "doctor",
    title: "24/7 Doctor House Call Service",
    icon: Stethoscope,
    subServices: [
      {
        ...
        benefits: [
          { title: "Convenience", text: "A doctor comes directly to you, saving time and avoiding the need to travel while unwell." },
          { title: "Accessibility", text: "Get professional medical care and treatment for common conditions without visiting a clinic." },
          { title: "Timely Care", text: "Receive fast in-person assessment for minor illnesses without long waiting times." },
        ],
      },
      {
        id: "gp-home-visit",
        name: "General Practitioner Home Visit",
        price: "300.000",
        ...
        benefits: [
          { title: "Convenience", text: "A healthcare professional visits you directly, saving time and travel." },
          { title: "Accessibility", text: "Get professional medical care for common conditions without visiting a clinic." },
          { title: "Timely Care", text: "Receive fast assessment for minor illnesses without long waiting times." },
          { title: "Cost-Effective", text: "More affordable than a clinic visit by reducing travel and time-off costs." },
        ],
      },
      {
        id: "specialist-home-visit",
        name: "Specialist Medical Home Visit",
        price: "750.000",
        ...
        benefits: [
          { title: "Pediatrician", text: "Visit from a doctor specializing in the medical care of infants, children, and adolescents." },
          { title: "Surgeon", text: "Assessment from a medical professional skilled in surgical procedures." },
          { title: "Aesthetic Doctor", text: "Visit from a medical practitioner with expertise in aesthetic or cosmetic medicine." },
        ],
      },
      {
        id: "leave-letter",
        name: "Medical Certificate Home Visit",
        price: "350.000",
        desc: "A doctor visits you at home to assess your condition and issue an official medical certificate for work or school.",
        image: "/images/Doctor-Consultation/Online-Sick-Leave-Letter.webp",
        benefits: [
          { title: "Convenience", text: "Get assessed and receive a medical certificate without visiting a physical clinic." },
          ...
          { title: "Comfort", text: "Recover comfortably at home while being properly assessed by a doctor." },
        ],
      },
    ],
  },
